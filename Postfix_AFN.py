...
def basic(input):
    ...
    transition = {"desde": afn.estadoInicial, "=>": input, "hacia": [afn.estadoFinal]}
...
def evaluatePostfix(regex):
    ...
    with open("resultadoAFN.txt", "w") as f:
        ...
        print(lang)
        f.write("\n")
        f.write("estado_incial: ")
        f.write(str(afn.estadoInicial))
        f.write("\n")
        f.write("estado_final: ")
...
def ejecutar(regex):
    try:
        ...
        print(
            "La expresion regular ingresada es incorrecta revisela y vuela a intentar"
        )
